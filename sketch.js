...
function setup() {
  ...
  pendulum1 = new Pendulum(340, 450, "#800080");
  pendulum2 = new Pendulum(400, 450, "#8A2BE2");
  pendulum3 = new Pendulum(460, 450, "#9400d3");
  pendulum4 = new Pendulum(520, 450, "#8a2be2");
  pendulum5 = new Pendulum(580, 450, "#800080");
